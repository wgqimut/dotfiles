...
values."
  (setq-default
   ...
   '(
     ...
     auto-completion
     ;;(ycmd :variables
      ;;     ycmd-server-command (list "python" (file-truename "~/.config/emacs/ycmd/ycmd/"))
   ...
   dotspacemacs-excluded-packages '(org-projectile evil-escape)
...
you should place your code here."
  ...
  ;; when we switch project, we just wanna find some tag
